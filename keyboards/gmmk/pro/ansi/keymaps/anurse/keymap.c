...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [L_DEFAULT] = LAYOUT(
        ...
        TG(L_CAPS) ,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,           KC_ENT,           KC_PGDN,
    ...
    [L_CAPS] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,          _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
        _______, _______, _______,                            _______,                            _______, MO(L_FN), _______, _______, _______, _______
    ),
...
void keyboard_post_init_user(void) {
    ...
    rgb_matrix_set_color_all(RGB_HOTPINK); // Default startup colour
}

void rgb_matrix_indicators_user(void) {
    switch(get_highest_layer(layer_state)) {
    case L_DEFAULT:
        rgb_matrix_set_color_all(RGB_HOTPINK);
        break;
    case L_FN:
